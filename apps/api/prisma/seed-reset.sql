-- =============================================================
-- RutaYa — Reset + Seed (preserva superadmin)
-- Ejecutar con: psql $DATABASE_URL -f seed-reset.sql
-- =============================================================
...
-- Recrear superadmin (contraseña: rutaya2024)
INSERT INTO companies (id, name, "taxId", phone, city, email, password, role, "createdAt", "updatedAt")
VALUES (
  'superadmin',
  'RutaYa Admin',
  NULL,
  '+591 00000000',
  'La Paz',
  'superadmin@rutaya.bo',
  '$2b$10$rGzAzK3hnJCbsV7EG4mR4uYs359Xl7ZhPFLG5swpG8TzE8fo7BZIy',
  'superadmin',
  NOW(),
  NOW()
...
('co_bolivar',   'Bolívar Bus',        '1002345678', '+591 2 2441100', 'La Paz',
 'admin@bolivarbus.bo',
 '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p362ln93yanxBGMBjRRxGG', 'admin',
 'Banco Bisa', '1234567890', 'Bolívar Bus S.R.L.', NULL, NOW(), NOW()),

('co_copacabana', 'Trans Copacabana',  '1009876543', '+591 2 2115500', 'La Paz',
 'admin@transcopacabana.bo',
 '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p362ln93yanxBGMBjRRxGG', 'admin',
 'Banco Nacional de Bolivia', '9876543210', 'Trans Copacabana Ltda.', NULL, NOW(), NOW()),

('co_dorado',    'El Dorado',          '1005554433', '+591 3 3441200', 'Santa Cruz',
 'admin@eldorado.bo',
 '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p362ln93yanxBGMBjRRxGG', 'admin',
 'Banco Mercantil Santa Cruz', '5544332211', 'El Dorado S.A.', NULL, NOW(), NOW()),

('co_yungas',    'Flota Yungas',       '1007778899', '+591 2 2319900', 'La Paz',
 'admin@flotayungas.bo',
 '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p362ln93yanxBGMBjRRxGG', 'admin',
 'Banco Bisa', '7778899001', 'Flota Yungas S.R.L.', NULL, NOW(), NOW()),

('co_jumbo',     'Jumbo Bus',          '1001122334', '+591 4 4651300', 'Cochabamba',
 'admin@jumbobus.bo',
 '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p362ln93yanxBGMBjRRxGG', 'admin',
 'Banco de Crédito de Bolivia', '1122334455', 'Jumbo Bus Cochabamba S.A.', NULL, NOW(), NOW()),

('co_sur',       'Expreso del Sur',    '1006677889', '+591 4 6641100', 'Tarija',
 'admin@expresodelsur.bo',
 '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p362ln93yanxBGMBjRRxGG', 'admin',
 'Banco Unión', '6677889900', 'Expreso del Sur Ltda.', NULL, NOW(), NOW()),

('co_potosi',    'Pullman Potosí',     '1003344556', '+591 2 6223300', 'Potosí',
 'admin@pullmanpotosi.bo',
 '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p362ln93yanxBGMBjRRxGG', 'admin',
 'Banco Nacional de Bolivia', '3344556677', 'Pullman Potosí S.R.L.', NULL, NOW(), NOW()),

('co_scexpress', 'Santa Cruz Express', '1008899001', '+591 3 3561400', 'Santa Cruz',
 'admin@scruzexpress.bo',
 '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p362ln93yanxBGMBjRRxGG', 'admin',
 'Banco Mercantil Santa Cruz', '8899001122', 'SCZ Express S.A.', NULL, NOW(), NOW());
...
-- Verificación
SELECT 'superadmins preservados' AS info, COUNT(*) AS total FROM companies WHERE role = 'superadmin'
UNION ALL
SELECT 'companies (sin superadmin)', COUNT(*) FROM companies WHERE role != 'superadmin'
UNION ALL
